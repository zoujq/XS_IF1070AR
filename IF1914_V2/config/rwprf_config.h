...
//  <e> CFG_PRF_BASS
//  <i> Device Information Service Server Role
//  </e>
#if ( 1 )
#define CFG_PRF_BASS
#endif
...
//  <e> CFG_PRF_FMPL
//  <i> Find Me Profile Locator role
//  </e>
#if ( 0 )
#define CFG_PRF_FMPL
#endif
//  <e> CFG_PRF_PXPR
//  <i> Proximity Reporter
//  </e>
#if ( 0 )
#define CFG_PRF_PXPR
#endif
...
//  <e> CFG_PRF_HRPS
//  <i> Heart Rate Profile Sensor Role
//  <i> Heart Rate Profile Sensor Role
//  </e>
#if ( 0 )
#define CFG_PRF_HRPS
...
//  <e> CFG_PRF_WECHAT
//  <i> WECHAT Profile Target role
//  </e>
#if ( 0 )
#define CFG_PRF_WECHAT
#endif


// </h>

///OTAS Profile Server role
#if defined(CFG_PRF_OADS)
#define BLE_OADS_SERVER        1
#else
#define BLE_OADS_SERVER        0
#endif // defined(CFG_PRF_OADS)


///FFF0 Profile Locator role
#if defined(CFG_PRF_FFF0)
#define BLE_FFF0_SERVER        1
#else
#define BLE_FFF0_SERVER        0
#endif // defined(CFG_PRF_FFF0)


///FEE0 Profile Locator role
#if defined(CFG_PRF_FEE0)
#define BLE_FEE0_SERVER        1
#else
#define BLE_FEE0_SERVER        0
#endif // defined(CFG_PRF_FEE0)


///FFE0 Profile Locator role
#if defined(CFG_PRF_FFE0)
#define BLE_FFE0_SERVER        1
#else
#define BLE_FFE0_SERVER        0
#endif // defined(CFG_PRF_FFF0)
...
#if (defined(CFG_PRF_DISS) || BLE_APP_HRPS)
...
///wechat Profile server role
#if defined(CFG_PRF_WECHAT)
#define BLE_WECHAT_SERVER       1
#else
#define BLE_WECHAT_SERVER       0
#endif // defined(CFG_PRF_WECHAT)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
		...
		|| BLE_FFF0_SERVER || BLE_FFE0_SERVER || BLE_FEE0_SERVER)
